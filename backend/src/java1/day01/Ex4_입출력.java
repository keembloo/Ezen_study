...
public class Ex4_입출력 { // class s
	public static void main(String[] args) {	//main s
		...
		//1. 출력 :
			...
			// 2. System.out.PrintIn ( "출력하고싶은말" 또는 변수명 );	: 출력후 줄바꿈
			System.out.println("출력문구3");
			System.out.println("출력문구4");
			// 3. System.out.Printf ( "형식/포멧 문자" , 값/변수 );		: 형식문자열에 맞추어 값 출력
			//[p.69] %d:정수 %f:실수 %s:문자열 		%자릿수d : 오른쪽정렬 	%-자릿수d : 왼쪽정렬
			// %자릿수d : 오른쪽정렬 		%-자릿수d : 왼쪽정렬	%06d : 비어있는 자릿수 0채움
			// .소수점자릿수f : 소수점자릿수만큼 출력
			
			int value = 123;
			System.out.printf("상품의 가격 : %d원 \n" , value);	//%d 위치에 value 변수 출력
			System.out.printf("상품의 가격 : %6d원 \n" , value);	//%6d : 6칸 정수 자리에 value 변수 출력 [자리수가 비어있으면 공백처리]
			System.out.printf("상품의 가격 : %-6d원 \n" , value);  //%-6d : 6칸 정수 자리에 value 변수 출력 [자리수가 비어있으면 공백처리]
			System.out.printf("상품의 가격 : %06d원 \n" , value);  //%06d : 6칸 정수 자리에 value 변수 출력 [자리수가 비어있으면 0처리]
			...
			// 2. 입력
				// 1. 입력 객체 생성한다.
					// Scan + 컨트롤 + 스페이스바 => Scanner : 클래스(설계도) 도면
			...
			String 문자열 = scanner.next();
						// scanner.next(); : 띄어쓰기 x 	vs	scanner.nextLine(); : 띄어쓰기o포함
					// 3. 변수에 출력 확인
