...
public class Ex1_제한된타입파라미터 {
	...
	public static void main(String[] args) {
		...
		// String result3 = compare("안녕" , "하세요");  // 오류발생 : Number클래스 자손 아니므로 불가능
		
		Integer i = 3; // 정수형 int 클래스 = Integer/ Integer클래스는 Number클래스의 자손 / int는 정수타입
		Double d = 3.0; //Double 클래스는 Number클래스의 자손
		String s = "aa"; //String 클래스는 Number클래스의 자손 아니다
