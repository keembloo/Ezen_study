//문제11
let 정수1 = Number(prompt('정수1을 입력하세요'))
let 정수2 = Number(prompt('정수2을 입력하세요'))
let 정수3 = Number(prompt('정수3을 입력하세요'))
let max = 0;
let mid = 0;
let min = 0;


정수1 > 정수2 && 정수1 > 정수3 ? max=정수1 : 
		정수2 > 정수1 && 정수2 > 정수3 ? max=정수2 : 
				정수3 > max ? max=정수3 : max=max; //max

정수1 < 정수2 && 정수1 < 정수3 ? min=정수1 :
		정수2 < 정수1 && 정수2 < 정수3 ? min=정수2 :
