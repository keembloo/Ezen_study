...
/*
	1. 서버 웹소켓 만들기
		...
		3. 서버 웹소켓의 필수 메소드
			@OnOpen		: 클라이언트소켓이 서버소켓에 엽결이 접속 되었을때
...
public class ChattingSocket {
	...
	// 3. 
	@OnMessage // 클라이언트가 서버소켓의 메세지를 보냈을때 연결/매핑
	public void onMessage(Session session , String msg) {
		System.out.println(msg); // 클라이언트 소켓으로부터 메세지를 받았을때
		// 현재 접속한 명단(클라이언트소켓)들에게 메세지 전달
