...
/*
	1. document.querySelector(선택자); 		: 해당 선택자의 dom 객체로 가져오기		[객체]
...
/* 0. 제품목록에서의 선택상자 모두 체크기능 */
	...
	checkList[0].addEventListener('click' , (e)=>{
		console.log('첫번째 체크박스를 클릭');
		console.log(e);
		console.log(checkList[0].checked); 
		// type="checkbox" 인 input 태그는 checked 속성 이용한 체크여부확인하기 true: 체크되어있는 상태 / false: 체크 안된상태
